"""Compatibility shim: msseg.mscoupon.widgets moved to msseg.labeler.widgets.

Kept so existing imports keep working and -- for the classifier pickles, which
record a step's class by module path -- so msseg.mscoupon.widgets.<Class>
...
module directly.
"""
from msseg.labeler import widgets as _framework_module
