"""Compatibility shim: msseg.mscoupon.model_search moved to msseg.labeler.model_search.

Kept so existing imports keep working and -- for the classifier pickles, which
record a step's class by module path -- so msseg.mscoupon.model_search.<Class>
...
module directly.
"""
from msseg.labeler import model_search as _framework_module
