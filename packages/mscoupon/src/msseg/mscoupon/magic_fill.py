"""Compatibility shim: msseg.mscoupon.magic_fill moved to msseg.labeler.magic_fill.

Kept so existing imports keep working and -- for the classifier pickles, which
record a step's class by module path -- so msseg.mscoupon.magic_fill.<Class>
...
module directly.
"""
from msseg.labeler import magic_fill as _framework_module
