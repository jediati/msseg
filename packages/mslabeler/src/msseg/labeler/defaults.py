...
# Whether a released magic fill is an EXTENT ("this set IS the object": its
# outer seams become boundary labels, derive.py) or a sample. The blobber's
# core is always an extent, its ring never; a lasso is an extent unless
# Ctrl-dragged.
_DEFAULT_MAGIC_EXTENT = True
